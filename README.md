Whatsapp — Front‑end Clone (HTML · CSS · JavaScript)

🚀 Project Overview

This project is a front‑end clone of a messaging‑app interface inspired by WhatsApp, created using only HTML, CSS, and a bit of JavaScript. It replicates a familiar chat‑application layout — chat list sidebar, chat windows, message bubbles, header/navigation — to simulate the look and feel of a real messaging platform. There’s no backend or real‑time messaging; the focus is purely on front‑end design, layout, and basic interactivity.
...
Vanilla JavaScript (for basic front‑end interactivity)
...
Interact with the UI — click on chats in the sidebar to view corresponding messages.

(Optional) Modify HTML/CSS/JS to customize the style or add features.
